...
// Helper function to get price by day number, type, age group, and membership status
export var getPriceByDay = function (dayNumber, isVeg, ageGroup, isMember) {
    if (ageGroup === void 0) { ageGroup = 'adult'; }
    if (isMember === void 0) { isMember = false; }
    var key = "DAY".concat(dayNumber);
    if (key in DAILY_PRICES) {
        var priceType = !isVeg ? DAILY_PRICES[key].NON_VEG : DAILY_PRICES[key].VEG;
        var membershipType = isMember ? 'member' : 'guest';
        return priceType[membershipType][ageGroup];
    }
    return 0;
};
export var durgaPujaMeals2025 = [
    {
        date: '2025-09-28',
        day: 'Day 1 - Shashti',
        vegItems: [
            {
                ...
                price: DAILY_PRICES.DAY1.VEG.guest.adult,
                category: 'veg',
                available: true
            }
        ],
        nonVegItems: [
            {
                ...
                price: DAILY_PRICES.DAY1.NON_VEG.guest.adult,
                category: 'non-veg',
                available: true
            }
        ]
        ...
        vegItems: [
            {
                ...
                price: DAILY_PRICES.DAY2.VEG.guest.adult,
                category: 'veg',
                available: true
            }
        ],
        nonVegItems: [
            {
                ...
                price: DAILY_PRICES.DAY2.NON_VEG.guest.adult,
                category: 'non-veg',
                available: true
            }
        ]
        ...
        vegItems: [
            {
                ...
                price: DAILY_PRICES.DAY3.VEG.guest.adult,
                category: 'veg',
                available: true
            }
        ]
